import { GALLERY_SETS } from "../lib/colombiaImages";

const now = new Date().toISOString();

const gallery = (type) => GALLERY_SETS[type] || GALLERY_SETS.default;
...
export const SEED_PROPERTIES = [
  ...
  },
  {
    ...
    furnished: "amoblado",
    pets_allowed: true,
    amenities: ["Terraza", "Gimnasio", "Seguridad 24h", "Piscina"],
    images: gallery("apartamento"),
  ...
  },
  {
    ...
    furnished: "sin_amoblar",
    pets_allowed: true,
    amenities: ["Piscina", "Salón comunal", "Seguridad 24h"],
    images: gallery("apartamento"),
