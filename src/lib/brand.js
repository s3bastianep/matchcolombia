...
export const BRAND = {
  ...
  logoWordmark: "/habibar-wordmark.png?v=21",
  logoWordmark2x: "/habibar-wordmark@2x.png?v=21",
  logoStacked: "/habibar-logo.png?v=21",
  logo: "/habibar-wordmark.png?v=21",
  logoIcon: `/habibar-icon.png?v=${FAVICON_VERSION}`,
  logoMark: `/habibar-mark.svg?v=${FAVICON_VERSION}`,
  splashMark: "/habibar-wordmark.png?v=21",
  social: {
